...
g = {}
with open(
    os.path.join(os.path.dirname(__file__), "..", "invenio_marc21", "version.py"), "rt"
) as fp:
    exec(fp.read(), g)
...
html_theme_options = {
    ...
    "extra_nav_links": {
        "invenio-marc21@GitHub": "https://github.com/tu-graz-library/invenio-marc21",
...
latex_documents = [
    (
        master_doc,
        "invenio-marc21.tex",
        u"invenio-marc21 Documentation",
        u"CERN",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "invenio-marc21", u"invenio-marc21 Documentation", [author], 1)
]

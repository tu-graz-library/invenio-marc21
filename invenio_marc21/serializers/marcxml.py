...
class MARCXMLSerializer(DoJSONSerializer):
    ...
    def __init__(
        self, dojson_model, xslt_filename=None, schema_class=None, replace_refs=False
    ):
        ...
        """
        self.dumps_kwargs = dict(xslt_filename=xslt_filename) if xslt_filename else {}

        self.schema_class = schema_class
        super(MARCXMLSerializer, self).__init__(dojson_model, replace_refs=replace_refs)
    ...
    def serialize(self, pid, record, links_factory=None):
        ...
        """
        return dumps(
            self.transform_record(pid, record, links_factory), **self.dumps_kwargs
        )

...
def teardown_module():
    ...
    for cmd in ["FLASK_APP=app.py flask db destroy --yes-i-know", "rm -rf instance"]:
...
def test_example_app():
    ...
    for cmd in [
        "FLASK_APP=app.py flask npm",
        "cd static && npm install && cd ..",
        "npm install -g node-sass@3.8.0 clean-css@3.4.12" " requirejs uglify-js",
